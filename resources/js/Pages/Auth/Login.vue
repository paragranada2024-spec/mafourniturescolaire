    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="text-center">
                <h1 class="text-3xl font-bold text-[#0a2342] dark:text-white mb-2">
        ...
        <div class="mt-8 mx-4 sm:mx-auto sm:w-full sm:max-w-md">
            <div
                class="bg-white dark:bg-gray-800 py-8 px-4 shadow-lg rounded-2xl sm:px-10 border border-gray-200 dark:border-gray-700">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" v-model="form.email" type="email" autocomplete="email" required :class="[
